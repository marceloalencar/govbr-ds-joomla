                        ...
                        <div class="header-actions">
                            <div class="header-links dropdown">
                                ...
                                <div class="br-list">
                                    ...
                                    <a class="br-item" href="javascript:void(0)">Link de acesso 1</a><a class="br-item" href="javascript:void(0)">Link de acesso 2</a><a class="br-item" href="javascript:void(0)">Link de acesso 3</a><a class="br-item" href="javascript:void(0)">Link de acesso 4</a>
                                </div>
                            </div>
                            ...
                            <div class="header-login">
                                ...
                                <div class="header-avatar d-none">
                                    <div class="avatar dropdown">
                                        <span class="br-avatar" title="Fulano da Silva"><span class="image"><img src="https://picsum.photos/id/823/400" alt="Avatar"/></span></span>
                                                    ...
                                                    <nav class="tab-nav">
                                                        <ul>
                                                            <li class="tab-item notification-tooltip" data-tooltip-text="Alertas">
                                                                <button type="button" aria-label="Alertas" data-panel="notification-panel-1-18020"><span class="name"><i class="fas fa-bell" aria-hidden="true"></i></span></button>
                                                            </li>
                                                            <li class="tab-item notification-tooltip active" data-tooltip-text="Mensagens">
                                                                <button type="button" aria-label="Mensagens" data-panel="notification-panel-2-18020"><span class="name"><i class="fas fa-envelope" aria-hidden="true"></i></span></button>
                                                            </li>
                                                        </ul>
                                                    </nav>
